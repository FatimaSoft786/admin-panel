...
const [request, setRequest] = useState([]);
 ...
 const accountApproved = async(docId)=>{  
     ...
     axios
        .post(
          "https://video-medical-backend-production.up.railway.app/admin/accountApproval",data,
          {
            headers: {
 ...
 const accountDeclined = async(docId)=>{  
    ...
    const data = {
      ...
      axios
        .post(
          "https://video-medical-backend-production.up.railway.app/admin/doctorsList",data,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
